...
<?php $form = ActiveForm::begin(); ?>
	<div class="tab-content clearfix">
		<div class="tab-pane active" id="1b">
			...
			<div class="row">
				<div class="col-md-5">
					<h5 class="form-title">Информация о товаре</h5>
					
					<div class="row form-group">
						<div class="col-md-5">
							<div class="form-group">
                                <?= $form->field($model, 'order_number')->label('Номер заказа<span class="form-label-important">*</span>') ?>
							</div>
						</div>
						<div class="col-md-7">
							<div class="form-group">
								<?= $form->field($model, 'date')->label('Дата приезда<span class="form-label-important">*</span>') ?>
							</div>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-md-5">
					<div class="row form-group">
						<div class="col-md-5">
							<div class="form-group">
                                ...
                                <?= $form->field($model, 'item_code')->label('Код товара<span class="form-label-important">*</span>') ?>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
									...
									<?= $form->field($model, 'item_quantity')->label('Количество <span class="form-label-important">*</span>') ?>
					...
					<!-- <a href="" class="add-more-field"><span>+</span> Добавить еще один товар</a> -->
				</div>

				<div class="col-md-5">
					<div class="form-group">
                        <?= $form->field($model, 'reason')->textarea(['rows' => 7])->label('Укажите причины возврата<span class="form-label-important">*</span>') ?>
					</div>
				</div>
			</div>

            <?= Html::submitButton('Отправить заявку', ['class' => 'btn btn-blue form-button-margin']) ?>
