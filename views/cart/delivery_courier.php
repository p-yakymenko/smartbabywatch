					...
					<div class="tab-content clearfix">
                        ...
                        <div class="tab-pane active">
                            ...
                            <?php $form = ActiveForm::begin() ?>
                                    <?= $form->field($model, 'delivery_city')->label('Город<span class="form-label-important">*</span>') ?>
                                    <?= $form->field($model, 'delivery_courier')->label('Курьерская служба<span class="form-label-important">*</span>') ?>
