...
<section class="section-catalog">
	...
	<a href="">Мои заказы </a>
	<span class="catalog-title-next"></span>
	<small>Возврат товара</small>
</h3>
<p class="profile-top-subtext">Вы можете отследить местоположение вашего заказа, указав номер трекинга заказа</p>

<div class="row">
	<div class="col-md-5">
		<div class="form-group">
			<input type="text" class="form-control form-input" placeholder="Номер трекинга">
		</div>
	</div>
	<div class="col-md-3">
		<button type="submit" class="btn btn-blue btn-standart">Отследить заказ</button>
	</div>
</div>
