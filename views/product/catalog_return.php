...
<form action="/" method="post">
	<div class="tab-content clearfix">
		<div class="tab-pane active" id="1b">
			...
			<div class="row">
				<div class="col-md-5">
					<h5 class="form-title">Информация о заказе</h5>
					
					<div class="row form-group">
						<div class="col-md-5">
							<div class="form-group">
								<label>Номер заказа <span class="form-label-important">*</span></label>
			...
			<h5 class="form-title">Список товаров</h5>
			...
			<div class="row">
				<div class="col-md-5">
					<div class="row form-group">
						<div class="col-md-5">
							<div class="form-group">
								<label>Код товара <span class="form-label-important">*</span></label>
								<input type="text" class="form-control form-input">
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label>Количество <span class="form-label-important">*</span></label>
				...
				<div class="col-md-5">
					<div class="form-group">
						<label class="form-label">Укажите причины возврата</label>
						<textarea name="" rows="7" class="form-control form-input"></textarea>
					</div>
				</div>
			</div>

			<button type="submit" class="btn btn-blue form-button-margin">Отправить заявку</button>
