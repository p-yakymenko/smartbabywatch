...
<section class="section-catalog">
	...
	Мои резервы <span>2 товара</span>
</h3> 

<form action="/" method="post">
	<div class="form-row">
		<div class="form-field ">
			<ul  class="nav nav-pills nav-pills-merge nav-rezerv nav-pills-merge-block">
				<li class="active">
					<a href="#1b" data-toggle="tab">Создать заявку</a>
				</li>
				<li class="">
					<a href="#2b" data-toggle="tab">Условия возврата</a>
				</li>
			</ul>
		</div>
		<div class="form-field form-field-subcategory form-select-style form-rezerv-select">
...
<div class="tab-content clearfix">
	<div class="tab-pane active" id="1b">
		...
		<ul class="table-rezerv-top">
			<li class="table-rezerv-text">№ резерва: <span>123<span></li>
			<li class="table-rezerv-text">Товаров: <span>2<span></li>
			<li class="table-rezerv-text table-rezerv-auto">01.02.2017 в 11:48</li>
			<li class="table-rezerv-button"><a href="" class="color-red"><img src="style/img/icons/delete-red.png" alt=""> Отменить заказ</a></li>
			<li class="table-rezerv-button"><a href="" class="color-blue"><img src="style/img/icons/edit-blue.png" alt=""> Редактировать заказ</a></li>
		</ul>

		<div class="table-responsive">
			<table class="catalog-table table vertical-aling">
	...
	<div class="tab-pane " id="2b">
		...
		<div class="table-responsive">
			<table class="catalog-table table gray">
				<thead>
					<tr>
			...
			<button type="submit" class="btn btn-blue pull-right btn-icon"><img src="style/img/icons/reload.png" alt=""> Повторить заказ</button>
		</div>
