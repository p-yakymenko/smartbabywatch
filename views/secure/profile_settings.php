...
<body> 
	...
	<div class="catalog-user-right wid wow fadeInUp" data-wow-delay="0.3s">
		...
		<p class="profile-top-subtext">Вы зарегистрированы как физическое лицо. Для регистрации и заказов для юридических лиц – зарегистрируйтесь как юридическое лицо</p>



		<ul  class="nav nav-pills margin">
			<li class="active">
				<a href="#1b" data-toggle="tab">Мой аккаунт</a>
			</li>
			<li class="">
				<a href="#2b" data-toggle="tab">Адреса доставки</a>
			</li> 
		</ul>
		...
		<form action="/" method="post">
				...
				<div class="tab-pane active" id="1b">
					...
					<div class="row">
						<div class="col-md-5">
							...
							<div class="row form-group form-row-center">
								<div class="col-md-4">
							...
							<div class="row form-group form-row-center">
								<div class="col-md-4">
									<span class="form-field-name">Пароль доступа</span>
								</div>
								<div class="col-md-8">
									<a href="">Изменить</a>
								</div>
							...
							<div class="row form-group form-row-center">
								<div class="col-md-4">
									<span class="form-field-name">Номер телефона</span>
								</div>
								<div class="col-md-8">
									<input type="text" class="form-control form-input">
								</div>
						...
						<div class="col-md-5 col-md-offset-1">
							...
							<div class="checkbox checkbox-margin">
			                    ...
			                    <label for="c1">
			                        Отправлять на email уведомлении о появлении товара на складе
			                    </label>
			                </div>
			                <div class="checkbox checkbox-margin">
			                    <input id="c2" type="checkbox">
			                    <label for="c2">
			                        Отправлять на email изменения статуса заказа
			                    </label>
			                </div>
			                <div class="checkbox checkbox-margin">
			                    <input id="c3" type="checkbox">
			                    <label for="c3">
			                        Отправлять на email новости компании
			                    </label>
			                </div>
						</div>
					</div>
				...
				<div class="tab-pane" id="2b">
					<div class="table-responsive">
						<table class="catalog-table table vertical-aling gray">
							<thead>
								<tr>
									<th class=""><div>Город</div></th>
									<th class=""><div>Улица</div></th>
									<th class=""><div>Дом, корпус</div></th>
									<th class=""><div>Квартира, офис</div></th>
									<th class="last"><div>GPS координаты</div></th>
									<th class=""></th>
								</tr>
							</thead>
							<tbody>
			...
			<button type="submit" class="btn btn-blue form-button-margin">Сохранить настройки</button>
		</form>
	</div>
</section>
